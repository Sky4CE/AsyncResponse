        ...
        public void Schedule()
            => _ = Task.Run(async () =>
            {
                ...
                catch (Exception ex)
                {
                    ...
                    owner._logger.LogError(ex, "Error handling PostgreSQL waiter timeout for correlationId {CorrelationId}.", correlationId);
                }
            });
    }
        ...
        public async ValueTask CleanupOnceAsync(bool deleteRecoveryState)
        {
            ...
            try
            {
                ...
                catch (Exception ex)
                {
                    ...
                    _owner._logger.LogError(ex, "Failed to delete PostgreSQL recovery state for correlationId {CorrelationId}.", _correlationId);
                }
                ...
                catch (Exception ex)
                {
                    ...
                    _owner._logger.LogError(ex, "Failed to delete PostgreSQL subscriber row for correlationId {CorrelationId}.", _correlationId);
                }
            }
            finally
            {
