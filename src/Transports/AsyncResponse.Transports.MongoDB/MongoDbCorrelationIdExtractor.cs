...
/// JSON response body via configured paths.
/// </summary>
internal static class MongoDbCorrelationIdExtractor
{
    ...
    {
        var headerName = MongoDbTransportOptionsValidator.Required(options.CorrelationIdHeader, nameof(options.CorrelationIdHeader));
