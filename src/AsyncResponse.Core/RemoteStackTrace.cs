...
internal static class RemoteStackTrace
{
    ...
    public static string? Cap(string? stackTrace, int maxLength)
    {
        ...
        // failing — the shared cut backs off to the last whole code point.
        return string.Concat(PortableText.TruncateWellFormed(stackTrace, maxLength), TruncationMarker);
    }
}
