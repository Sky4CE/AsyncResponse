# Summary - AsyncResponse
<details open><summary>Summary</summary>

|||
|:---|:---|
| Generated on: | 07/31/2026 - 14:49:37 |
| Parser: | MultiReport (3x Cobertura) |
| Assemblies: | 27 |
| Classes: | 438 |
| Files: | 199 |
| **Line coverage:** | 98.2% (23117 of 23537) |
| Covered lines: | 23117 |
| Uncovered lines: | 420 |
| Coverable lines: | 23537 |
| Total lines: | 36307 |
| **Branch coverage:** | 94.8% (7958 of 8388) |
| Covered branches: | 7958 |
| Total branches: | 8388 |
...
|**Name**|**Line**|**Branch**|
|:---|---:|---:|
|**AsyncResponse.Channels.MongoDB**|**99.2%**|**98.4%**|
|AsyncResponse.Channels.DbAsyncResponseChannelBase|100%|97.7%|
...
|AsyncResponse.Channels.DbAsyncResponseChannelBase<T>|100%|97.7%|
...
|AsyncResponse.Channels.MongoDB.MongoDbChannelStore|99.6%|100%|
|AsyncResponse.Channels.MongoDB.MongoDbChannelStore<TDocument>|99.6%|100%|
...
<details><summary>AsyncResponse.Channels.NATS - 96%</summary>

|**Name**|**Line**|**Branch**|
|:---|---:|---:|
|**AsyncResponse.Channels.NATS**|**96%**|**90%**|
|AsyncResponse.Channels.NATS.NatsAsyncResponseChannel|93.9%|84.6%|
|AsyncResponse.Channels.NATS.NatsAsyncResponseChannel<T>|93.9%|84.6%|
...
|AsyncResponse.Channels.DbAsyncResponseChannelBase|99.4%|99.1%|
|AsyncResponse.Channels.DbAsyncResponseChannelBase.DbSubscription<T>|100%|100%|
|AsyncResponse.Channels.DbAsyncResponseChannelBase.DbSubscription<T>|100%|100%|
|AsyncResponse.Channels.DbAsyncResponseChannelBase.PendingConfirmation|100%||
|AsyncResponse.Channels.DbAsyncResponseChannelBase<T>|99.4%|99.1%|
...
<details><summary>AsyncResponse.Channels.Redis - 95.6%</summary>

|**Name**|**Line**|**Branch**|
|:---|---:|---:|
|**AsyncResponse.Channels.Redis**|**95.6%**|**90.3%**|
|AsyncResponse.Channels.Redis.RedisAsyncResponseChannel|94.6%|87.8%|
|AsyncResponse.Channels.Redis.RedisAsyncResponseChannel<T>|94.6%|87.8%|
...
<details><summary>AsyncResponse.Channels.SqlServer - 99.7%</summary>

|**Name**|**Line**|**Branch**|
|:---|---:|---:|
|**AsyncResponse.Channels.SqlServer**|**99.7%**|**99%**|
...
|AsyncResponse.Channels.SqlServer.SqlServerChannelSql|99.7%|98.7%|
...
<details><summary>AsyncResponse.Core - 98.3%</summary>

|**Name**|**Line**|**Branch**|
|:---|---:|---:|
|**AsyncResponse.Core**|**98.3%**|**93.4%**|
|AsyncResponse.AsyncResponseBuilder|100%|100%|
|AsyncResponse.AsyncResponseBuilder<T>|100%|100%|
|AsyncResponse.AsyncResponseBuilder<T>|100%|100%|
|AsyncResponse.AsyncResponseBuilderBase|97.5%|100%|
...
|AsyncResponse.AsyncResponseDiagnostics|100%|94%|
...
|AsyncResponse.DurableFlowContext|95.6%|86.9%|
|AsyncResponse.DurableFlowContext<TFlow, TInput>|95.6%|86.9%|
|AsyncResponse.DurableFlowContext<TResponse>|95.6%|86.9%|
|AsyncResponse.DurableFlowContext<TResult>|95.6%|86.9%|
...
|AsyncResponse.FlowExecutionLease|100%|87.5%|
|AsyncResponse.FlowStateConcurrency|100%|100%|
|AsyncResponse.FlowStateJson|100%|100%|
|AsyncResponse.InMemoryAsyncResponseChannel|98.8%|93%|
...
|AsyncResponse.InMemoryAsyncResponseChannel.SubscriptionGroup|93.1%|96.8%|
|AsyncResponse.InMemoryAsyncResponseChannel.SubscriptionSnapshot|100%|100%|
|AsyncResponse.InMemoryAsyncResponseChannel<T>|98.8%|93%|
...
|AsyncResponse.InMemoryRecoveryStateStore|96.1%|92.8%|
|AsyncResponse.InMemoryRecoveryStateStore.Entry|100%||
|AsyncResponse.InMemoryRecoveryStateStore.EntryBucket|92.8%|92.6%|
|AsyncResponse.InMemoryWorkerHost|90%|90%|
...
|AsyncResponse.LostSubscriberCallbackDispatcher|98.6%|90%|
|AsyncResponse.LostSubscriberCallbackDispatcher<T>|98.6%|90%|
|AsyncResponse.PayloadRecoveryClassifier|100%|95%|
...
|Microsoft.Extensions.DependencyInjection.AsyncResponseCoreServiceCollection<br/>Extensions<TFlow, TInput>|100%|95%|
|Microsoft.Extensions.DependencyInjection.AsyncResponseCoreServiceCollection<br/>Extensions<TFlowStateStore, TOptions>|100%|95%|
...
<details><summary>AsyncResponse.DurableFlows.Cosmos - 96.7%</summary>

|**Name**|**Line**|**Branch**|
|:---|---:|---:|
|**AsyncResponse.DurableFlows.Cosmos**|**96.7%**|**91.7%**|
...
|AsyncResponse.DurableFlows.Internal.DurableFlowStoreShared|95.5%|90%|
...
<details><summary>AsyncResponse.DurableFlows.DynamoDB - 98.6%</summary>

|**Name**|**Line**|**Branch**|
|:---|---:|---:|
|**AsyncResponse.DurableFlows.DynamoDB**|**98.6%**|**89.1%**|
...
|AsyncResponse.DurableFlows.Internal.DurableFlowStoreShared|95.5%|92%|
|AsyncResponse.DurableFlows.Internal.FlowStateTooLargeException|100%||
...
|**Name**|**Line**|**Branch**|
|:---|---:|---:|
|**AsyncResponse.DurableFlows.EFCore**|**96.1%**|**82.6%**|
...
|AsyncResponse.DurableFlows.Internal.DurableFlowStoreShared|91.1%|78%|
|AsyncResponse.DurableFlows.Internal.FlowStateTooLargeException|0%||
...
|**Name**|**Line**|**Branch**|
|:---|---:|---:|
|**AsyncResponse.DurableFlows.MongoDB**|**100%**|**96.7%**|
|AsyncResponse.DurableFlows.Internal.DurableFlowStoreShared|100%|96%|
|AsyncResponse.DurableFlows.Internal.FlowStateTooLargeException|100%||
|AsyncResponse.DurableFlows.MongoDB.MongoDbDurableFlowOptions|100%|100%|
|AsyncResponse.DurableFlows.MongoDB.MongoDbFlowStateStore|100%|96.1%|
...
<details><summary>AsyncResponse.DurableFlows.MySql - 94.5%</summary>

|**Name**|**Line**|**Branch**|
|:---|---:|---:|
|**AsyncResponse.DurableFlows.MySql**|**94.5%**|**80.5%**|
|AsyncResponse.DurableFlows.Internal.DurableFlowStoreShared|92.6%|78%|
|AsyncResponse.DurableFlows.Internal.FlowStateTooLargeException|0%||
...
<details><summary>AsyncResponse.DurableFlows.Oracle - 94.5%</summary>

|**Name**|**Line**|**Branch**|
|:---|---:|---:|
|**AsyncResponse.DurableFlows.Oracle**|**94.5%**|**84.7%**|
|AsyncResponse.DurableFlows.Internal.DurableFlowStoreShared|92.6%|84%|
|AsyncResponse.DurableFlows.Internal.FlowStateTooLargeException|0%||
...
<details><summary>AsyncResponse.DurableFlows.PostgreSQL - 93.9%</summary>

|**Name**|**Line**|**Branch**|
|:---|---:|---:|
|**AsyncResponse.DurableFlows.PostgreSQL**|**93.9%**|**82%**|
|AsyncResponse.DurableFlows.Internal.DurableFlowStoreShared|91.1%|78%|
|AsyncResponse.DurableFlows.Internal.FlowStateTooLargeException|0%||
...
<details><summary>AsyncResponse.DurableFlows.Sqlite - 98.8%</summary>

|**Name**|**Line**|**Branch**|
|:---|---:|---:|
|**AsyncResponse.DurableFlows.Sqlite**|**98.8%**|**93%**|
|AsyncResponse.DurableFlows.Internal.DurableFlowStoreShared|95.5%|92%|
|AsyncResponse.DurableFlows.Internal.FlowStateTooLargeException|100%||
...
<details><summary>AsyncResponse.DurableFlows.SqlServer - 95%</summary>

|**Name**|**Line**|**Branch**|
|:---|---:|---:|
|**AsyncResponse.DurableFlows.SqlServer**|**95%**|**80.5%**|
|AsyncResponse.DurableFlows.Internal.DurableFlowStoreShared|92.6%|78%|
|AsyncResponse.DurableFlows.Internal.FlowStateTooLargeException|0%||
...
<details><summary>AsyncResponse.ServiceDefaults - 96.9%</summary>

|**Name**|**Line**|**Branch**|
|:---|---:|---:|
|**AsyncResponse.ServiceDefaults**|**96.9%**|**75%**|
|Extensions|96.9%|75%|
...
|AsyncResponse.Transports.AzureServiceBus.AzureServiceBusWorkerTransport|100%|85.7%|
...
|AsyncResponse.Transports.Kafka.KafkaMessageDispatcher|100%|98.1%|
...
<details><summary>AsyncResponse.Transports.MongoDB - 94.9%</summary>

|**Name**|**Line**|**Branch**|
|:---|---:|---:|
|**AsyncResponse.Transports.MongoDB**|**94.9%**|**96.1%**|
...
|AsyncResponse.Transports.MongoDB.MongoDbCorrelationIdExtractor|100%|100%|
|AsyncResponse.Transports.MongoDB.MongoDbMessageDispatcher|88.9%|100%|
...
|AsyncResponse.Transports.MongoDB.MongoDbSubscriberService|84.1%|83.3%|
...
|AsyncResponse.Transports.MongoDB.MongoDbTransportStore|96.2%|92.8%|
...
|Microsoft.Extensions.DependencyInjection.MongoDbAsyncResponseTransportServi<br/>ceCollectionExtensions|97.1%|92.8%|
...
<details><summary>AsyncResponse.Transports.PostgreSQL - 96.5%</summary>

|**Name**|**Line**|**Branch**|
|:---|---:|---:|
|**AsyncResponse.Transports.PostgreSQL**|**96.5%**|**99.5%**|
...
|AsyncResponse.Transports.PostgreSQL.PostgreSqlCorrelationIdExtractor|100%|100%|
|AsyncResponse.Transports.PostgreSQL.PostgreSqlMessageDispatcher|92.4%|100%|
...
|AsyncResponse.Transports.RabbitMQ.RabbitMqMessageDispatcher|100%|98.3%|
...
|AsyncResponse.Transports.RabbitMQ.RabbitMqSubscriberService|88.2%|87.5%|
...
|**Name**|**Line**|**Branch**|
|:---|---:|---:|
|**AsyncResponse.Transports.Redis**|**100%**|**98.5%**|
...
|AsyncResponse.Transports.Redis.RedisMessageDispatcher|100%|96.5%|
...
<details><summary>AsyncResponse.Transports.SqlServer - 95.6%</summary>

|**Name**|**Line**|**Branch**|
|:---|---:|---:|
|**AsyncResponse.Transports.SqlServer**|**95.6%**|**99.1%**|
...
|AsyncResponse.Transports.SqlServer.SqlServerCorrelationIdExtractor|100%|100%|
|AsyncResponse.Transports.SqlServer.SqlServerMessageDispatcher|88.2%|100%|
...
|AsyncResponse.Transports.SqlServer.SqlServerTransportStore|93.2%|95.2%|
...
|**Name**|**Line**|**Branch**|
|:---|---:|---:|
|**AsyncResponse.Transports.SQS**|**98.7%**|**94.9%**|
