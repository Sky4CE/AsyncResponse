...
|||
|:---|:---|
| Generated on: | 08/14/2026 - 12:56:42 |
| Parser: | MultiReport (16x Cobertura) |
| Assemblies: | 27 |
| Classes: | 491 |
| Files: | 215 |
| **Line coverage:** | 97.7% (29133 of 29805) |
| Covered lines: | 29133 |
| Uncovered lines: | 672 |
| Coverable lines: | 29805 |
| Total lines: | 44675 |
| **Branch coverage:** | 93.4% (10794 of 11556) |
| Covered branches: | 10794 |
| Total branches: | 11556 |
| **Method coverage:** | [Feature is only available for sponsors](https://reportgenerator.io/pro) |

</details>

## Coverage
<details><summary>AsyncResponse.Abstractions - 98.2%</summary>

|**Name**|**Line**|**Branch**|
|:---|---:|---:|
|**AsyncResponse.Abstractions**|**98.2%**|**100%**|
...
|AsyncResponse.IDurableFlowExecutionObserver|50%||
...
<details><summary>AsyncResponse.Channels.MongoDB - 98.9%</summary>

|**Name**|**Line**|**Branch**|
|:---|---:|---:|
|**AsyncResponse.Channels.MongoDB**|**98.9%**|**98.8%**|
|AsyncResponse.Channels.DbAsyncResponseChannelBase|99.2%|98.1%|
...
|AsyncResponse.Channels.DbAsyncResponseChannelBase<T>|99.2%|98.1%|
...
|**Name**|**Line**|**Branch**|
|:---|---:|---:|
|**AsyncResponse.Channels.NATS**|**99.4%**|**96.3%**|
|AsyncResponse.Channels.NATS.NatsAsyncResponseChannel|99.3%|94.7%|
|AsyncResponse.Channels.NATS.NatsAsyncResponseChannel<T>|99.3%|94.7%|
...
|AsyncResponse.Channels.NATS.NatsRecoveryStateStore|100%|100%|
...
|**Name**|**Line**|**Branch**|
|:---|---:|---:|
|**AsyncResponse.Channels.Redis**|**98.8%**|**97.7%**|
|AsyncResponse.Channels.Redis.RedisAsyncResponseChannel|98.6%|97.5%|
|AsyncResponse.Channels.Redis.RedisAsyncResponseChannel<T>|98.6%|97.5%|
...
|**Name**|**Line**|**Branch**|
|:---|---:|---:|
|**AsyncResponse.Channels.SqlServer**|**99.4%**|**96.6%**|
|AsyncResponse.Channels.DbAsyncResponseChannelBase|99.1%|97.3%|
|AsyncResponse.Channels.DbAsyncResponseChannelBase.DbSubscription<T>|100%|100%|
|AsyncResponse.Channels.DbAsyncResponseChannelBase.DbSubscription<T>|100%|100%|
|AsyncResponse.Channels.DbAsyncResponseChannelBase.PendingConfirmation|100%||
|AsyncResponse.Channels.DbAsyncResponseChannelBase<T>|99.1%|97.3%|
...
|AsyncResponse.Channels.SqlServer.SqlServerChannelSql|99.8%|98.2%|
|AsyncResponse.Channels.SqlServer.SqlServerRecoveryStateStore|100%|100%|
|AsyncResponse.Channels.SqlServer.SqlServerTransientFaults|100%|100%|
|AsyncResponse.Internal.SqlServerRelationVerifier|100%|89.5%|
...
|AsyncResponse.AsyncResponseDurableFlowStoreMarker|100%|100%|
...
|AsyncResponse.AsyncResponseWatchdog|97.1%|93.5%|
...
|AsyncResponse.CallbackExpressionConverter|100%|93.1%|
|AsyncResponse.CallbackExpressionConverter.MethodCallGuard|100%|83.3%|
...
|AsyncResponse.CronSchedule|97.4%|96.8%|
|AsyncResponse.DurableAsyncResponseChannelOptions|100%||
|AsyncResponse.DurableFlowContext|93.4%|85.6%|
|AsyncResponse.DurableFlowContext<TFlow, TInput>|93.4%|85.6%|
|AsyncResponse.DurableFlowContext<TResponse>|93.4%|85.6%|
|AsyncResponse.DurableFlowContext<TResult>|93.4%|85.6%|
...
|AsyncResponse.FlowStateConcurrency|100%|97.9%|
...
|AsyncResponse.InMemoryAsyncResponseChannel.Subscription<T>|100%|100%|
|AsyncResponse.InMemoryAsyncResponseChannel.SubscriptionBase|99%|95.4%|
...
|AsyncResponse.InMemoryFlowStateStore|100%|93.1%|
...
|AsyncResponse.InMemoryWorkerTransport|86.9%|72.7%|
...
|AsyncResponse.LostSubscriberCallbackDispatcher|99%|91.6%|
|AsyncResponse.LostSubscriberCallbackDispatcher<T>|99%|91.6%|
...
|AsyncResponse.ReflectionExtensions|100%|100%|
|AsyncResponse.ReflectionExtensions.ConversionPlan|100%|100%|
...
|AsyncResponse.WorkerJobExecutor|95.8%|76.4%|
|AsyncResponse.WorkerJobSkewScope|90.9%|50%|
|AsyncResponse.WorkerJobSkewScope.Scope|83.3%|50%|
...
<details><summary>AsyncResponse.DurableFlows.Cosmos - 96.5%</summary>

|**Name**|**Line**|**Branch**|
|:---|---:|---:|
|**AsyncResponse.DurableFlows.Cosmos**|**96.5%**|**93.6%**|
|AsyncResponse.DurableFlows.Cosmos.CosmosDurableFlowOptions|80.9%|85%|
...
<details><summary>AsyncResponse.DurableFlows.DynamoDB - 98.1%</summary>

|**Name**|**Line**|**Branch**|
|:---|---:|---:|
|**AsyncResponse.DurableFlows.DynamoDB**|**98.1%**|**88.7%**|
|AsyncResponse.DurableFlows.DynamoDB.DynamoDbDurableFlowOptions|78.2%|68.1%|
...
|**Name**|**Line**|**Branch**|
|:---|---:|---:|
|**AsyncResponse.DurableFlows.EFCore**|**99.5%**|**95.3%**|
...
|AsyncResponse.DurableFlows.EFCore.FlowIdCollationRules.CaseFoldingProviderR<br/>ules|100%||
|AsyncResponse.DurableFlows.Internal.DurableFlowStoreShared|100%|100%|
|AsyncResponse.DurableFlows.Internal.FlowStateTooLargeException|100%||
...
|**Name**|**Line**|**Branch**|
|:---|---:|---:|
|**AsyncResponse.DurableFlows.MySql**|**99.7%**|**91.8%**|
|AsyncResponse.DurableFlows.Internal.DurableFlowStoreShared|100%|100%|
|AsyncResponse.DurableFlows.Internal.FlowStateTooLargeException|100%||
|AsyncResponse.DurableFlows.MySql.MySqlDurableFlowOptions|100%|100%|
|AsyncResponse.DurableFlows.MySql.MySqlFlowStateStore|99.6%|86.9%|
|AsyncResponse.DurableFlows.MySql.MySqlFlowStateStore.ActualColumn|100%|100%|
...
<details><summary>AsyncResponse.DurableFlows.Oracle - 97.9%</summary>

|**Name**|**Line**|**Branch**|
|:---|---:|---:|
|**AsyncResponse.DurableFlows.Oracle**|**97.9%**|**93%**|
|AsyncResponse.DurableFlows.Internal.DurableFlowStoreShared|100%|100%|
|AsyncResponse.DurableFlows.Internal.FlowStateTooLargeException|100%||
|AsyncResponse.DurableFlows.Oracle.OracleDurableFlowOptions|100%|100%|
|AsyncResponse.DurableFlows.Oracle.OracleFlowStateStore|97.2%|88%|
|AsyncResponse.DurableFlows.Oracle.OracleFlowStateStore.ActualColumn|100%|100%|
|AsyncResponse.DurableFlows.Oracle.OracleFlowStateStore.ExpectedColumn|100%|92.3%|
...
|**Name**|**Line**|**Branch**|
|:---|---:|---:|
|**AsyncResponse.DurableFlows.SqlServer**|**80.4%**|**63.2%**|
|AsyncResponse.DurableFlows.Internal.DurableFlowStoreShared|100%|100%|
|AsyncResponse.DurableFlows.Internal.FlowStateTooLargeException|100%||
|AsyncResponse.DurableFlows.SqlServer.SqlServerDurableFlowOptions|100%|100%|
|AsyncResponse.DurableFlows.SqlServer.SqlServerFlowStateStore|95.1%|72.2%|
|AsyncResponse.Internal.SqlServerRelationVerifier|56%|45.8%|
...
|**Name**|**Line**|**Branch**|
|:---|---:|---:|
|**AsyncResponse.Testing**|**89.1%**|**80.1%**|
|AsyncResponse.Testing.AsyncResponseTestHarness|90.5%|79.4%|
...
|AsyncResponse.Testing.FlowTestHarness<TFlow, TInput>|100%|50%|
|AsyncResponse.Testing.SimulatedCrashException|100%|100%|
|AsyncResponse.Testing.VirtualTimeProvider|83.8%|92.5%|
|AsyncResponse.Testing.VirtualTimeProvider.VirtualTimer|92.6%|86.3%|
...
|**Name**|**Line**|**Branch**|
|:---|---:|---:|
|**AsyncResponse.Transports.AzureServiceBus**|**97.8%**|**92.3%**|
...
<details><summary>AsyncResponse.Transports.MongoDB - 97.8%</summary>

|**Name**|**Line**|**Branch**|
|:---|---:|---:|
|**AsyncResponse.Transports.MongoDB**|**97.8%**|**97.8%**|
|AsyncResponse.Internal.MongoOwnershipLedger|100%|83.3%|
|AsyncResponse.Transports.DbCorrelationIdExtractor|100%|100%|
|AsyncResponse.Transports.DbMessageDispatcherBase|93.6%|100%|
...
|AsyncResponse.Transports.MongoDB.MongoDbTransportStore|96.7%|100%|
|AsyncResponse.Transports.MongoDB.MongoDbWorkerSubscriber|100%||
|AsyncResponse.Transports.MongoDB.MongoDbWorkerTransport|100%|71.4%|
...
|**Name**|**Line**|**Branch**|
|:---|---:|---:|
|**AsyncResponse.Transports.NATS**|**100%**|**96.9%**|
...
|**Name**|**Line**|**Branch**|
|:---|---:|---:|
|**AsyncResponse.Transports.PostgreSQL**|**97.1%**|**93%**|
...
|AsyncResponse.Transports.PostgreSQL.PostgreSqlSubscriberService|100%|100%|
...
|AsyncResponse.Transports.PostgreSQL.PostgreSqlTransportStore|95%|97.8%|
...
<details><summary>AsyncResponse.Transports.RabbitMQ - 97.9%</summary>

|**Name**|**Line**|**Branch**|
|:---|---:|---:|
|**AsyncResponse.Transports.RabbitMQ**|**97.9%**|**96.3%**|
|AsyncResponse.Transports.RabbitMQ.AwaitingRabbitMqMessageDispatcher|64.7%|100%|
...
|AsyncResponse.Transports.RabbitMQ.RabbitMqMessageDispatcher|99.1%|98.2%|
...
|AsyncResponse.Transports.RabbitMQ.RabbitMqWorkerTransport|97.8%|79.4%|
...
|AsyncResponse.Transports.Redis.RedisTransportOptionsValidator|100%|94.4%|
...
<details><summary>AsyncResponse.Transports.SqlServer - 99.5%</summary>
